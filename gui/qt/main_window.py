...
from electrum_dash.util import format_satoshis, format_satoshis_plain, format_time
from electrum_dash.util import PrintError, NotEnoughFunds, StoreDict
...
from electrum_dash.paymentrequest import PaymentRequest, get_payment_request
...
class ElectrumWindow(QMainWindow, PrintError):
    ...
    def init_menubar(self):
        ...
        help_menu.addAction(_("&Documentation"), lambda: webbrowser.open("https://docs.electrum-dash.org/")).setShortcut(QKeySequence.HelpContents)
    ...
    def show_report_bug(self):
        ...
        QMessageBox.information(self, "Electrum-DASH - " + _("Reporting Bugs"), msg)
